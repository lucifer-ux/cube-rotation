    ...
    return function (dictPlus) {
        return function (f) {
            return foldr(dictFoldable)((function () {
                var $312 = Control_Alt.alt(dictPlus.Alt0());
                return function ($313) {
                    return $312(f($313));
                };
        ...
        return function (u) {
            return function (xs) {
                return Data_Newtype.unwrap()(Data_Newtype.unwrap()(foldMap(dictFoldable)(Data_Monoid_Dual.monoidDual(Data_Monoid_Endo.monoidEndo(Control_Category.categoryFn)))((function () {
                    var $318 = Data_Function.flip(c);
                    return function ($319) {
                        return Data_Monoid_Dual.Dual(Data_Monoid_Endo.Endo($318($319)));
                    };
                })())(xs)))(u);
            };
        };
...
var foldrDefault = function (dictFoldable) {
    return function (c) {
        return function (u) {
            return function (xs) {
                return Data_Newtype.unwrap()(foldMap(dictFoldable)(Data_Monoid_Endo.monoidEndo(Control_Category.categoryFn))(function ($320) {
                    return Data_Monoid_Endo.Endo(c($320));
                })(xs))(u);
            };
        };
    };
...
var lookup = function (dictFoldable) {
    return function (dictEq) {
        return function (a) {
            ...
            var $322 = foldMap(dictFoldable)(Data_Maybe_First.monoidFirst)(function (v) {
                var $303 = Data_Eq.eq(dictEq)(a)(v.value0);
                if ($303) {
...
var notElem = function (dictFoldable) {
    return function (dictEq) {
        return function (x) {
            ...
            var $328 = elem(dictFoldable)(dictEq)(x);
            return function ($329) {
                return $327($328($329));
            };
        };
