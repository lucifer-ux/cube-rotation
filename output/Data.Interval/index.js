...
var functorInterval = {
    map: Data_Bifunctor.bimap(bifunctorInterval)(Control_Category.identity(Control_Category.categoryFn))
};
var extendInterval = {
    extend: function (f) {
        return function (v) {
...
module.exports = {
    ...
    Duration: Data_Interval_Duration.Duration,
    Day: Data_Interval_Duration.Day,
    Hour: Data_Interval_Duration.Hour,
    Minute: Data_Interval_Duration.Minute,
    Month: Data_Interval_Duration.Month,
    Second: Data_Interval_Duration.Second,
    Week: Data_Interval_Duration.Week,
    Year: Data_Interval_Duration.Year,
    day: Data_Interval_Duration.day,
    hour: Data_Interval_Duration.hour,
    millisecond: Data_Interval_Duration.millisecond,
    minute: Data_Interval_Duration.minute,
    month: Data_Interval_Duration.month,
    second: Data_Interval_Duration.second,
    week: Data_Interval_Duration.week,
